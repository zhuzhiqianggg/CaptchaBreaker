...
| v6.0 | 多策略集成+后处理 | ~60-65% | 4种预处理策略+投票+字符纠错 |
...
│  ├─ 投票算法: Counter 多数投票 + 置信度辅助
│  └─ 最终选择: 投票结果优先，否则选择最高置信度
│
└─ 预期准确率: 60-65% (v5.0: 60%)

实际测试效果 (前5张样本):
- 2zrw.png: [OK] ✓
- 6QxJ.png: [FAIL] (期望: 6qxj, 识别: qxj) - 首字符丢失
- 78sq.png: [FAIL] (期望: 78sq, 识别: ds8) - 字符混淆
- aDkP.png: [OK] ✓
- aYWW.png: [OK] ✓
准确率: 60% (3/5)
```
